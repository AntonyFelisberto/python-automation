...
text = "hi there you here exa_mple@example.com and example@example.com some more text here and there another@example.de"

pattern = re.compile("[a-z]+@[a-z]+.[a-z]+",re.IGNORECASE)
matches = pattern.findall(text)
print(matches)

pattern = re.compile("[^  ]+@[^  ]+.[a-z]+",re.IGNORECASE) #^ any character except space
matches = pattern.findall(text)
print(matches)